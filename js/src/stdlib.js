...
var Interscript = {
  ...
  correct_boundaries: function () {
    ...
    this.aliases.boundary =
      ...
      word +
      "))";
    this.aliases.non_word_boundary =
      "(?:^(?=" +
      non_word +
      ")|(?<=" +
      non_word +
  ...
  map_exist: function (map) {
    return this.maps[map] !== "undefined" && this.maps[map] !== null;
  },
