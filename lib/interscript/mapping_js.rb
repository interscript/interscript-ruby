  ...
  class Mapping
    ...
    def load_and_serialize_system_mappings
      if depth < 5
        ...
        # raise Interscript::InvalidSystemError.new("No system mappings found") unless mappings.
    ...
    def load_system_mappings
      # Hash.new(`window.yaml_files[#{system_code}]`) # Hash.new not working with json string
